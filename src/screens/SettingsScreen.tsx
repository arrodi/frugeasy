...
const styles = StyleSheet.create({
  ...
  content: { paddingHorizontal: 0, paddingVertical: 16, gap: 12 },
  title: { fontSize: 20, fontWeight: '800', color: '#156530', paddingHorizontal: 16 },
  textDark: { color: '#d6f5df' },
  group: { backgroundColor: '#f4fff6', borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#a7e6b4', paddingHorizontal: 16, paddingVertical: 12, gap: 10 },
  groupDark: { backgroundColor: '#102117', borderBottomColor: '#26523a' },
