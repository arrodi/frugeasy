...
const styles = StyleSheet.create({
  ...
  contentContainer: { flex: 1, paddingHorizontal: 0, gap: 10, paddingTop: 8, paddingBottom: 80 },
  ...
  card: { backgroundColor: '#eef5f2', padding: 12, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#d2e2dc' },
  ...
  net: { color: '#355f53' },
  budgetItem: { borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#8fdf8e', paddingHorizontal: 12, paddingVertical: 10, backgroundColor: '#f6fff8', marginBottom: 0 },
  ...
  panel: { backgroundColor: '#f4fff6', borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#a7e6b4', padding: 10, gap: 8, marginTop: 8 },
